...
This Tauri 2 tray shell packages `dmxtract_bridge` as a sidecar. It keeps the browser-facing bridge process out of the web application, displays the requesting origin and six-digit pairing code in the native tray menu, and kills the sidecar on Quit.
